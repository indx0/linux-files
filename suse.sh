zypper ar -f -n packman http://ftp.gwdg.de/pub/linux/misc/packman/suse/openSUSE_Leap_$releasever/ packman
sudo zypper install git haruna telegram-desktop obs-studio nodejs virtualbox 
